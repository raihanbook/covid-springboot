...
public class CovidModel implements Serializable {
    ...
    private final static long serialVersionUID = 550809011479467112L;
    ...
    public CovidModel withActiveCasesText(String activeCasesText) {
        this.activeCasesText = activeCasesText;
        return this;
    }
    ...
    public CovidModel withCountryText(String countryText) {
        this.countryText = countryText;
        return this;
    }
    ...
    public CovidModel withLastUpdate(String lastUpdate) {
        this.lastUpdate = lastUpdate;
        return this;
    }
    ...
    public CovidModel withNewCasesText(String newCasesText) {
        this.newCasesText = newCasesText;
        return this;
    }
    ...
    public CovidModel withNewDeathsText(String newDeathsText) {
        this.newDeathsText = newDeathsText;
        return this;
    }
    ...
    public CovidModel withTotalCasesText(String totalCasesText) {
        this.totalCasesText = totalCasesText;
        return this;
    }
    ...
    public CovidModel withTotalDeathsText(String totalDeathsText) {
        this.totalDeathsText = totalDeathsText;
        return this;
    }
    ...
    public CovidModel withTotalRecoveredText(String totalRecoveredText) {
        this.totalRecoveredText = totalRecoveredText;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CovidModel.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
